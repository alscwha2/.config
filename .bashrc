...
export LEET_HOME="$HOME/Projects/LeetCode"
export SELENIUM_CHROME_DRIVER_PATH="$HOME/Downloads/chromedriver"
alias lc="cd $HOME/Projects/LeetCode"
alias edit_leet="nvim $HOME/bin/leet"
alias bin="cd $HOME/bin"
alias down="cd $HOME/Downloads"
alias config="cd $HOME/.config"
alias vim="nvim"
alias updateapt="sudo apt update && sudo apt upgrade && sudo apt autoremove"
